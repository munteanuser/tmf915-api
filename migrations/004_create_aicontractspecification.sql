...
CREATE TABLE dbo.AiContractSpecification (
    ...
    spec_characteristic  NVARCHAR(MAX)    NULL,   -- JSON: []Characteristic
    created_at           DATETIME2        NOT NULL DEFAULT GETUTCDATE(),
    updated_at           DATETIME2        NOT NULL DEFAULT GETUTCDATE()
);
GO

CREATE INDEX IX_AiContractSpecification_name ON dbo.AiContractSpecification(name);
GO
